            ...
            <div className="form-container sign-in-container">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className='flex flex-col items-center w-2/3 mb-3'>
                        ...
                        <Typography className='font-bold font-PoppinsLight'>Sign in with</Typography>
                    ...
                    <div className="flex items-center justify-between text-gray-600 w-[60%] pb-8">
                        <div className="flex gap-2">
                            <input type="checkbox" name="rememberme" id="rememberme"/>
                            <label htmlFor='rememberme' className='font-PoppinsLight font-bold text-xs inline-block'>Remember me</label>
                        </div>
