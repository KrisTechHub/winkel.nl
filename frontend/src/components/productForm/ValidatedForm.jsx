...
export default function ValidatedForm () {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await axios.post(import.meta.env.VITE_PRODUCT_SERVER, formData, config);
    ...
    return (
        <div className='flex flex-col justify-center items-center text-center'>
            <div className='w-4/6 bg-primary-50 flex flex-col justify-start items-center relative'>
                ...
                <div className='w-4/6 items-center absolute top-72 pb-24'>
